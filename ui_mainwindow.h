...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget->setGeometry(QRect(0, 0, 451, 471));
        tab = new QWidget();
        ...
        groupBox->setGeometry(QRect(20, 340, 211, 61));
        horizontalLayoutWidget = new QWidget(groupBox);
        horizontalLayoutWidget->setObjectName(QStringLiteral("horizontalLayoutWidget"));
        horizontalLayoutWidget->setGeometry(QRect(0, 20, 205, 41));
        ...
        checkBox->setGeometry(QRect(360, 190, 85, 20));
        tabWidget->addTab(tab, QString());
        verticalLayoutWidget_2 = new QWidget(centralWidget);
        verticalLayoutWidget_2->setObjectName(QStringLiteral("verticalLayoutWidget_2"));
        verticalLayoutWidget_2->setGeometry(QRect(460, 20, 131, 451));
        ...
        progressBar->setGeometry(QRect(0, 480, 600, 20));
