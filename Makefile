#############################################################################
# Makefile for building: bin/fantasticTowns
# Generated by qmake (3.0) (Qt 5.5.1)
# Project:  fantasticTowns.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile fantasticTowns.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = fantasticTowns1.0.0
DISTDIR = /home/dave/Projects/fantasticTowns/.tmp/fantasticTowns1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro
LIBS          = $(SUBLIBS) -lsfml-graphics -lsfml-window -lsfml-system -lopencv_imgproc -lopencv_core -lnoise -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		fantasticTowns.pro src/GenerateHeightMapState.h \
		src/Heightmap.h \
...
Makefile: fantasticTowns.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile fantasticTowns.pro
...
ui_mainwindow.h: src/gui/mainwindow.ui
	/usr/lib/qt/bin/uic src/gui/mainwindow.ui -o ui_mainwindow.h
...
GenerateHeightMapState.o: src/GenerateHeightMapState.cpp src/GenerateHeightMapState.h \
		src/State.h \
		src/StateManager.h \
		src/Heightmap.h \
		src/HeightMapGenerator.h \
...
Heightmap.o: src/Heightmap.cpp src/Heightmap.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Heightmap.o src/Heightmap.cpp

HeightMapGenerator.o: src/HeightMapGenerator.cpp src/HeightMapGenerator.h \
		src/HeightMapModificationProcess.h \
		src/Heightmap.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o HeightMapGenerator.o src/HeightMapGenerator.cpp

HMMP_Erosion.o: src/HMMP_Erosion.cpp src/HMMP_Erosion.h \
		src/HeightMapModificationProcess.h \
		src/Heightmap.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o HMMP_Erosion.o src/HMMP_Erosion.cpp

HMMP_Volcanic.o: src/HMMP_Volcanic.cpp src/HMMP_Volcanic.h \
		src/HeightMapModificationProcess.h \
		src/Heightmap.h
...
NodeSampleAlgs.o: src/NodeSampleAlgs.cpp src/NodeSampleAlgs.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o NodeSampleAlgs.o src/NodeSampleAlgs.cpp

SquiglyLine.o: src/SquiglyLine.cpp src/SquiglyLine.h \
		src/ValueNoise.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SquiglyLine.o src/SquiglyLine.cpp

StateManager.o: src/StateManager.cpp src/StateManager.h \
		src/State.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o StateManager.o src/StateManager.cpp

utils.o: src/utils.cpp src/utils.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o utils.o src/utils.cpp

ValueNoise.o: src/ValueNoise.cpp src/ValueNoise.h
